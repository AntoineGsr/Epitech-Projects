...
int hexa_preci(char *nb_hexa, char *preci)
{
...
int array_hexa(unsigned int nb_decimal, char *nb_hexa,
...
int hexa(va_list list, char *preci)
{
    ...
    array_hexa(nb_decimal, nb_hexa, i, preci);
    return (0);
}
